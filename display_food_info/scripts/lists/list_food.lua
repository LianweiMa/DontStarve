...
local function GetIngredientList()
    local list_ingredient = {name = List(), tag = {type=List(),hunger=List(),health=List(),sanity=List()}}
    -- 遍历所有的食材。
...
local function GetFoodList()
    local list_food = {name = List(), tag = {type=List(),hunger=List(),health=List(),sanity=List()}}
    -- 遍历所有的食谱。
