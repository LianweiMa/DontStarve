...
dont_starve_compatible = true --是否兼容原版
reign_of_giants_compatible = true --是否兼容巨人DLC
shipwrecked_compatible = true --是否兼容海难
hamlet_compatible = true --是否兼容哈姆雷特

all_clients_require_mod = true --所有人都需要mod，true就是

icon_atlas = "food_act_cn.xml" --mod图标
icon = "food_act_cn.tex"
